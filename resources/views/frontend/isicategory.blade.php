			   			...
			   			<div class="row">
				   			<div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h1>Products</h1>
				   					<h2 class="bread"><span><a href="index.html">Home</a></span> <span>Category </span><span>{{$kategori->nama_category}}</span></h2>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
				...
				<div class="row">
					<div class="col-md-10 col-md-push-2">
						<div class="row row-pb-lg">
                                    @foreach ($kategori->product()->get() as $data) 
                                            <div class="col-md-4 text-center">
                                                <div class="product-entry">
                                                @foreach($data->product_image as $data1)   
                                                      <div class="product-img" style=" height: 290px; width:290px ; background-image: url({{ asset('assets/img/fotoproduct/'.$data1->foto)  }});" height="528" width="570">
                                                @endforeach
                                                            <div class="cart">
                                                                  <p>
